...
link to Sara Zanzottera or Steen Jensen, to add them into this list.
 ...
 * **LearnPyQt**: https://www.learnpyqt.com/ Longer, more descriptive PyQt5 tutorial with videos and example apps.
   ...
   Remember to ignore the section on Qt Creator: it is not supported in our infrastructure, but we use Qt Designer
   instead.
